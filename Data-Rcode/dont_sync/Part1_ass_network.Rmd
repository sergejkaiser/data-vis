---
title: "Excepts Assignment Network Part 1: Exploratory Analysis of the world trade network in the manufacturing industry"
...
```
```{r plot community subgraph, echo=TRUE, message=FALSE, warning=FALSE}
par(mfrow=c(1,2))
